...
export default function AuthModal({ isOpen, onClose, onOpenSettings }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2.5 sm:p-4 bg-black/70 backdrop-blur-sm">
      <div className="bg-[#1e1f20] border border-gemini-border w-full max-w-md rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[92dvh]">
        {/* Header */}
        ...
        {!isConfigured && (
          <div className="bg-amber-500/10 border-b border-amber-500/20 px-4 sm:px-5 py-2.5 sm:py-3 text-xs text-amber-300 flex items-start gap-2.5">
