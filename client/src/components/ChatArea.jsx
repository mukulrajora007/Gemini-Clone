    ...
    <div className="flex-1 overflow-y-auto relative flex flex-col">
      {messages.length === 0 ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6 max-w-3xl mx-auto w-full text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gemini-surface/80 border border-gemini-border text-xs text-gemini-muted mb-4">
          ...
          <h2 className="text-2xl md:text-3xl font-medium text-gemini-muted mb-8">
            ...
            {SUGGESTIONS.map((item, idx) => {
              ...
              return (
                <button
                  ...
                  className="p-4 rounded-xl bg-gemini-surface/60 hover:bg-gemini-surface border border-gemini-border/70 hover:border-gemini-accent/60 transition-all group flex flex-col justify-between h-28"
                >
                  <div className="flex items-center justify-between w-full">
                    <span className="font-medium text-sm text-gemini-text group-hover:text-white">
                      {item.title}
                    </span>
                    <Icon
                      size={18}
                      className="text-gemini-muted group-hover:text-gemini-accent transition-colors"
                    />
                  </div>
